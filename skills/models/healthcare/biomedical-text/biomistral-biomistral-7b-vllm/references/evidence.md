...
- Exact model source/model card: https://huggingface.co/BioMistral/BioMistral-7B
- BioMistral 7B source: https://huggingface.co/BioMistral/BioMistral-7B (model-card)
