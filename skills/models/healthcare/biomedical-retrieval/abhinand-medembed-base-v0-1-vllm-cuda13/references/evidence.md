...
- Exact model source/model card: https://huggingface.co/abhinand/MedEmbed-base-v0.1
- MedEmbed Base source: https://huggingface.co/abhinand/MedEmbed-base-v0.1 (model-card)
