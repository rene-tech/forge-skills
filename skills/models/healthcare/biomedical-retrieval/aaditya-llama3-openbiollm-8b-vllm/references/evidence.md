...
- Exact model source/model card: https://huggingface.co/aaditya/Llama3-OpenBioLLM-8B
- Llama3 OpenBioLLM 8B source: https://huggingface.co/aaditya/Llama3-OpenBioLLM-8B (model-card)
