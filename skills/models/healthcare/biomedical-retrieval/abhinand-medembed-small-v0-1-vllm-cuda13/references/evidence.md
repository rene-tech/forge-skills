...
- Exact model source/model card: https://huggingface.co/abhinand/MedEmbed-small-v0.1
- MedEmbed Small source: https://huggingface.co/abhinand/MedEmbed-small-v0.1 (model-card)
