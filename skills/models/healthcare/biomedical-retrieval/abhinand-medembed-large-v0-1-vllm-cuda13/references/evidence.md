...
- Exact model source/model card: https://huggingface.co/abhinand/MedEmbed-large-v0.1
- MedEmbed Large source: https://huggingface.co/abhinand/MedEmbed-large-v0.1 (model-card)
