---
name: use-forge-abhinand-medembed-large-v0-1-vllm-cuda13
description: Use exact Forge model abhinand-medembed-large-v0-1-vllm-cuda13 for text to embedding. Load when selecting, calling, comparing, interpreting, or deploying this specific version.
---

# Use MedEmbed Large

- Model slug: `abhinand-medembed-large-v0-1-vllm-cuda13`
- Family: `abhinand-medembed-large`
- Version: `hf-963121b-vllm-0.22.0-cuda13-pooling` (`hf-963121b-vllm-0-22-0-cuda13-pooling`)
...
MedEmbed Large is Abhinand Balachandran's Apache-2.0 sentence-transformers embedding model fine-tuned from BAAI/bge-large-en-v1.5 for medical and clinical information retrieval.

## Use this exact model when

- Use this exact `abhinand-medembed-large-v0-1-vllm-cuda13` version when the task supplies text and needs embedding.
- MedEmbed Large is Abhinand Balachandran's Apache-2.0 sentence-transformers embedding model fine-tuned from BAAI/bge-large-en-v1.5 for medical and clinical information retrieval.
...
- `input` (textarea; optional; default 'Clinical retrieval query: What evidence supports anticoagulation for stroke prevention in atrial fibrillation?\n\nCandidate passage: Randomized trials and guideline summaries report that anticoagulation lowers ischemic stroke risk in many adults with atrial fibrillation, with treatment choice depending on individualized bleeding risk and clinician review.'): Medical or clinical text
...
1. Load this skill and pin model slug `abhinand-medembed-large-v0-1-vllm-cuda13` with version key `hf-963121b-vllm-0-22-0-cuda13-pooling`.
...
- Model: `/v1/models/abhinand-medembed-large-v0-1-vllm-cuda13`
