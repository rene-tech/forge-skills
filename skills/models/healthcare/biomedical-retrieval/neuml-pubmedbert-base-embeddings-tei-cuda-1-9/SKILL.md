---
name: use-forge-neuml-pubmedbert-base-embeddings-tei-cuda-1-9
description: Use exact Forge model neuml-pubmedbert-base-embeddings-tei-cuda-1-9 for text to embedding. Load when selecting, calling, comparing, interpreting, or deploying this specific version.
---

# Use PubMedBERT Base Embeddings

- Model slug: `neuml-pubmedbert-base-embeddings-tei-cuda-1-9`
- Family: `neuml-pubmedbert-base-embeddings`
- Version: `hf-b79526d-tei-cuda-1.9.3` (`hf-b79526d-tei-cuda-1-9-3`)
...
- Use this exact `neuml-pubmedbert-base-embeddings-tei-cuda-1-9` version when the task supplies text and needs embedding.
- NeuML PubMedBERT Base Embeddings is an Apache-2.0 sentence-transformers model fine-tuned from PubMedBERT for biomedical sentence and paragraph embeddings.
...
1. Load this skill and pin model slug `neuml-pubmedbert-base-embeddings-tei-cuda-1-9` with version key `hf-b79526d-tei-cuda-1-9-3`.
...
- Model: `/v1/models/neuml-pubmedbert-base-embeddings-tei-cuda-1-9`
- Routes: `/v1/models/neuml-pubmedbert-base-embeddings-tei-cuda-1-9/inference-routes`
- Regional deployment: `/v1/models/neuml-pubmedbert-base-embeddings-tei-cuda-1-9/regional-deployment`
- Serverless handoff: `/v1/models/neuml-pubmedbert-base-embeddings-tei-cuda-1-9/deploy`
...
- Repository file: https://github.com/rene-tech/forge-skills/blob/main/skills/models/healthcare/biomedical-retrieval/neuml-pubmedbert-base-embeddings-tei-cuda-1-9/SKILL.md
