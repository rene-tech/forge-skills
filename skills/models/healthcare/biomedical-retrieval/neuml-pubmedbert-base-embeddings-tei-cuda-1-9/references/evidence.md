...
- Exact model source/model card: https://huggingface.co/NeuML/pubmedbert-base-embeddings
- PubMedBERT Base Embeddings source: https://huggingface.co/NeuML/pubmedbert-base-embeddings (model-card)
