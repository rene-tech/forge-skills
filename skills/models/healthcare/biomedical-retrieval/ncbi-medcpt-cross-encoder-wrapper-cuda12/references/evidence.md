...
- Exact model source/model card: https://huggingface.co/ncbi/MedCPT-Cross-Encoder
- MedCPT Cross Encoder source: https://huggingface.co/ncbi/MedCPT-Cross-Encoder (model-card)
