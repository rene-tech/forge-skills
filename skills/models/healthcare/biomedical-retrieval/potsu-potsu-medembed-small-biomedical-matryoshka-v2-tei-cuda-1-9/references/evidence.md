...
- Exact model source/model card: https://huggingface.co/potsu-potsu/medembed-small-biomedical-matryoshka-v2
- MedEmbed Small Biomedical Matryoshka v2 source: https://huggingface.co/potsu-potsu/medembed-small-biomedical-matryoshka-v2 (model-card)
