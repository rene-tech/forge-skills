...
- Exact model source/model card: https://huggingface.co/ncbi/MedCPT-Article-Encoder
- MedCPT Article Encoder source: https://huggingface.co/ncbi/MedCPT-Article-Encoder (model-card)
