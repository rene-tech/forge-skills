...
- Exact model source/model card: https://huggingface.co/laion/clap-htsat-fused
- LAION CLAP HTSAT Fused Zero-Shot Audio source: https://huggingface.co/laion/clap-htsat-fused (model-card)
