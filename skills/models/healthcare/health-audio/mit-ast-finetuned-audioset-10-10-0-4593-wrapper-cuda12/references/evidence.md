...
- Exact model source/model card: https://huggingface.co/MIT/ast-finetuned-audioset-10-10-0.4593
- MIT AST AudioSet Classifier source: https://huggingface.co/MIT/ast-finetuned-audioset-10-10-0.4593 (model-card)
