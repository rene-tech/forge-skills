...
- Exact model source/model card: https://github.com/qiuqiangkong/audioset_tagging_cnn
- PANNs CNN14 AudioSet Cough Baseline source: https://github.com/qiuqiangkong/audioset_tagging_cnn (repository)
