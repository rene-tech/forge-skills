...
- Exact model source/model card: https://huggingface.co/google/hear
- Google HeAR Health Acoustic Embeddings source: https://huggingface.co/google/hear (model-card)
