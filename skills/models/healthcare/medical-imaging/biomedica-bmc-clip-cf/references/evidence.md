...
- Exact model source/model card: https://huggingface.co/BIOMEDICA/BMC_CLIP_CF
- BIOMEDICA BMC-CLIP CF source: https://huggingface.co/BIOMEDICA/BMC_CLIP_CF (model-card)
