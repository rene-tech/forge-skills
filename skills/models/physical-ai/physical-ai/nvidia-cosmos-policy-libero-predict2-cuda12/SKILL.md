---
name: use-forge-nvidia-cosmos-policy-libero-predict2-cuda12
description: Use exact Forge model nvidia-cosmos-policy-libero-predict2-cuda12 for text, image, proprio to json. Load when selecting, calling, comparing, interpreting, or deploying this specific version.
---

# Use NVIDIA Cosmos Policy LIBERO Predict2 2B

- Model slug: `nvidia-cosmos-policy-libero-predict2-cuda12`
...
- Use this exact `nvidia-cosmos-policy-libero-predict2-cuda12` version when the task supplies text, image, proprio and needs json.
- Cosmos Policy LIBERO checkpoint wrapped as a Forge custom container.
...
1. Load this skill and pin model slug `nvidia-cosmos-policy-libero-predict2-cuda12` with version key `cuda12`.
...
- Model: `/v1/models/nvidia-cosmos-policy-libero-predict2-cuda12`
- Routes: `/v1/models/nvidia-cosmos-policy-libero-predict2-cuda12/inference-routes`
- Regional deployment: `/v1/models/nvidia-cosmos-policy-libero-predict2-cuda12/regional-deployment`
- Serverless handoff: `/v1/models/nvidia-cosmos-policy-libero-predict2-cuda12/deploy`
...
- Repository file: https://github.com/rene-tech/forge-skills/blob/main/skills/models/physical-ai/physical-ai/nvidia-cosmos-policy-libero-predict2-cuda12/SKILL.md
