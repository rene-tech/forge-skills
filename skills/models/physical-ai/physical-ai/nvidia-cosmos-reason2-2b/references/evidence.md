...
- Exact model source/model card: https://build.nvidia.com/nvidia/cosmos-reason2-8b/modelcard
- NVIDIA Cosmos Reason 2 (2B) source: https://build.nvidia.com/nvidia/cosmos-reason2-8b/modelcard (model-card)
