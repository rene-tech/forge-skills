---
name: use-forge-nvidia-cosmos-policy-aloha-predict2-cuda12
description: Use exact Forge model nvidia-cosmos-policy-aloha-predict2-cuda12 for text, image, proprio to json. Load when selecting, calling, comparing, interpreting, or deploying this specific version.
---

# Use NVIDIA Cosmos Policy ALOHA Predict2 2B

- Model slug: `nvidia-cosmos-policy-aloha-predict2-cuda12`
- Family: `nvidia-cosmos-policy-aloha-predict2`
- Version: `cuda12` (`cuda12`)
...
Cosmos Policy ALOHA checkpoint for real-world bimanual robot tasks.

## Use this exact model when

- Use this exact `nvidia-cosmos-policy-aloha-predict2-cuda12` version when the task supplies text, image, proprio and needs json.
- Cosmos Policy ALOHA checkpoint for real-world bimanual robot tasks.
...
1. Load this skill and pin model slug `nvidia-cosmos-policy-aloha-predict2-cuda12` with version key `cuda12`.
...
- Model: `/v1/models/nvidia-cosmos-policy-aloha-predict2-cuda12`
- Routes: `/v1/models/nvidia-cosmos-policy-aloha-predict2-cuda12/inference-routes`
- Regional deployment: `/v1/models/nvidia-cosmos-policy-aloha-predict2-cuda12/regional-deployment`
- Serverless handoff: `/v1/models/nvidia-cosmos-policy-aloha-predict2-cuda12/deploy`
...
- Repository file: https://github.com/rene-tech/forge-skills/blob/main/skills/models/physical-ai/physical-ai/nvidia-cosmos-policy-aloha-predict2-cuda12/SKILL.md
