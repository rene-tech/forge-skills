...
- Exact model source/model card: https://build.nvidia.com/nvidia/cosmos-reason1-7b
- NVIDIA Cosmos Reason 1 (7B) source: https://build.nvidia.com/nvidia/cosmos-reason1-7b (model-card)
