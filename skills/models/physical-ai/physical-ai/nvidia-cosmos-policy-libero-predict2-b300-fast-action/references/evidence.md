...
- Exact model source/model card: https://github.com/NVlabs/cosmos-policy
- NVIDIA Cosmos Policy LIBERO Predict2 2B (B300 Fast Action) source: https://github.com/NVlabs/cosmos-policy (repository)
