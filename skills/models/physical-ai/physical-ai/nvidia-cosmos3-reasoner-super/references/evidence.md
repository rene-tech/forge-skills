...
- Exact model source/model card: https://huggingface.co/nvidia-cosmos-ea/Cosmos3-Super-Reasoner
- NVIDIA Cosmos 3 Reasoner (Super) source: https://huggingface.co/nvidia-cosmos-ea/Cosmos3-Super-Reasoner (model-card)
