...
- Exact model source/model card: https://build.nvidia.com/nvidia/cosmos-reason2-8b
- NVIDIA Cosmos Reason 2 (8B) source: https://build.nvidia.com/nvidia/cosmos-reason2-8b (model-card)
