...
- Exact model source/model card: https://build.nvidia.com/nvidia/cosmos-transfer2_5-2b/modelcard
- NVIDIA Cosmos Transfer2.5 2B source: https://build.nvidia.com/nvidia/cosmos-transfer2_5-2b/modelcard (model-card)
