...
- Exact model source/model card: https://huggingface.co/nvidia-cosmos-ea/Cosmos3-Super
- NVIDIA Cosmos 3 Omni (Super) source: https://huggingface.co/nvidia-cosmos-ea/Cosmos3-Super (model-card)
