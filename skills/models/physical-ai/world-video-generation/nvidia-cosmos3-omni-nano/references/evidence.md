...
- Exact model source/model card: https://huggingface.co/nvidia-cosmos-ea/Cosmos3-Nano
- NVIDIA Cosmos 3 Omni (Nano) source: https://huggingface.co/nvidia-cosmos-ea/Cosmos3-Nano (model-card)
