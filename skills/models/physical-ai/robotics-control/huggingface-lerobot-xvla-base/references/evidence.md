...
- Exact model source/model card: https://huggingface.co/lerobot/xvla-base
- Hugging Face LeRobot X-VLA Base source: https://huggingface.co/lerobot/xvla-base (model-card)
