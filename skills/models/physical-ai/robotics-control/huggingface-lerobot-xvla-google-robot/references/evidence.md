...
- Exact model source/model card: https://huggingface.co/lerobot/xvla-google-robot
- Hugging Face LeRobot X-VLA Google Robot source: https://huggingface.co/lerobot/xvla-google-robot (model-card)
