...
- Exact model source/model card: https://huggingface.co/SberRoboticsCenter/GreenVLA-2b-base
- SberRoboticsCenter GreenVLA 2B Base source: https://huggingface.co/SberRoboticsCenter/GreenVLA-2b-base (model-card)
