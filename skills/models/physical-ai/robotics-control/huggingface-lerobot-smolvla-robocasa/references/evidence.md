...
- Exact model source/model card: https://huggingface.co/lerobot/smolvla_robocasa
- Hugging Face LeRobot SmolVLA RoboCasa source: https://huggingface.co/lerobot/smolvla_robocasa (model-card)
