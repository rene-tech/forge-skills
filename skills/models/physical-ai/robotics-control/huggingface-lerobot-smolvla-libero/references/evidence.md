...
- Exact model source/model card: https://huggingface.co/lerobot/smolvla_libero
- Hugging Face LeRobot SmolVLA Libero source: https://huggingface.co/lerobot/smolvla_libero (model-card)
