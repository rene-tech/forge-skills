...
- Exact model source/model card: https://huggingface.co/lerobot/smolvla_vlabench
- Hugging Face LeRobot SmolVLA VLABench source: https://huggingface.co/lerobot/smolvla_vlabench (model-card)
