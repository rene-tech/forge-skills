...
- Exact model source/model card: https://huggingface.co/lerobot/smolvla_robotwin
- Hugging Face LeRobot SmolVLA RobotWin source: https://huggingface.co/lerobot/smolvla_robotwin (model-card)
