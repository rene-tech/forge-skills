...
- Exact model source/model card: https://docs.nvidia.com/nim/bionemo/genmol/latest/
- GenMol NIM source: https://docs.nvidia.com/nim/bionemo/genmol/latest/ (model-card)
