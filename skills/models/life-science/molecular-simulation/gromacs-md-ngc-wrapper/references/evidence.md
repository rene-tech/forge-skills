...
- Exact model source/model card: https://catalog.ngc.nvidia.com/orgs/hpc/containers/gromacs
- GROMACS Molecular Dynamics source: https://catalog.ngc.nvidia.com/orgs/hpc/containers/gromacs (model-card)
