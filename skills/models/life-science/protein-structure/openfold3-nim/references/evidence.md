...
- Exact model source/model card: https://docs.nvidia.com/nim/bionemo/openfold3/latest/
- OpenFold3 NIM source: https://docs.nvidia.com/nim/bionemo/openfold3/latest/ (model-card)
