...
- Exact model source/model card: https://huggingface.co/InstaDeepAI/nucleotide-transformer-v2-500m-multi-species
- Nucleotide Transformer v2 500M Multi-Species DNA Embeddings source: https://huggingface.co/InstaDeepAI/nucleotide-transformer-v2-500m-multi-species (model-card)
