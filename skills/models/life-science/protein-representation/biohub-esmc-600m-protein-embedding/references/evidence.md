...
- Exact model source/model card: https://huggingface.co/biohub/ESMC-600M
- Biohub ESMC 600M Protein Embeddings source: https://huggingface.co/biohub/ESMC-600M (model-card)
