...
- Exact model source/model card: https://huggingface.co/Qwen/Qwen3-VL-4B-Instruct
- Qwen3-VL 4B Instruct source: https://huggingface.co/Qwen/Qwen3-VL-4B-Instruct (model-card)
