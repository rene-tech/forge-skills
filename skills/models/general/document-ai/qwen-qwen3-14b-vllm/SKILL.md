---
name: use-forge-qwen-qwen3-14b-vllm
description: Use exact Forge model qwen-qwen3-14b-vllm for text to text. Load when selecting, calling, comparing, interpreting, or deploying this specific version.
---

# Use Qwen3 14B

- Model slug: `qwen-qwen3-14b-vllm`
...
Qwen3 14B is a public Apache-2.0 dense text-generation model for hybrid reasoning, instruction following, multilingual chat, agent-style prompts, and long-context summarization.

## Use this exact model when

- Use this exact `qwen-qwen3-14b-vllm` version when the task supplies text and needs text.
- Qwen3 14B is a public Apache-2.0 dense text-generation model for hybrid reasoning, instruction following, multilingual chat, agent-style prompts, and long-context summarization.
...
- `prompt` (textarea; optional; default 'Use /think to reason briefly, then answer: A team has 9 failing tests, fixes 4, and introduces 2 new failures. How many tests are failing now?'): Prompt
...
1. Load this skill and pin model slug `qwen-qwen3-14b-vllm` with version key `vllm-0-10-2-cuda12-8`.
...
- Model: `/v1/models/qwen-qwen3-14b-vllm`
- Routes: `/v1/models/qwen-qwen3-14b-vllm/inference-routes`
- Regional deployment: `/v1/models/qwen-qwen3-14b-vllm/regional-deployment`
- Serverless handoff: `/v1/models/qwen-qwen3-14b-vllm/deploy`
...
- Repository file: https://github.com/rene-tech/forge-skills/blob/main/skills/models/general/document-ai/qwen-qwen3-14b-vllm/SKILL.md
