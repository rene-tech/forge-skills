...
- Exact model source/model card: https://huggingface.co/ByteDance-Seed/Seed-OSS-36B-Instruct
- Seed-OSS 36B Instruct source: https://huggingface.co/ByteDance-Seed/Seed-OSS-36B-Instruct (model-card)
