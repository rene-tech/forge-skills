...
- Exact model source/model card: https://huggingface.co/Qwen/Qwen3-Coder-30B-A3B-Instruct-FP8
- Qwen3-Coder 30B A3B Instruct FP8 source: https://huggingface.co/Qwen/Qwen3-Coder-30B-A3B-Instruct-FP8 (model-card)
