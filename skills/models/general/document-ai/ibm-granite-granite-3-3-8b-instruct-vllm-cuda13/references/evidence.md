...
- Exact model source/model card: https://huggingface.co/ibm-granite/granite-3.3-8b-instruct
- Granite 3.3 8B Instruct source: https://huggingface.co/ibm-granite/granite-3.3-8b-instruct (model-card)
