...
- Exact model source/model card: https://build.nvidia.com/microsoft/phi-4-mini-instruct/deploy
- Microsoft Phi-4 Mini Instruct source: https://build.nvidia.com/microsoft/phi-4-mini-instruct/deploy (model-card)
