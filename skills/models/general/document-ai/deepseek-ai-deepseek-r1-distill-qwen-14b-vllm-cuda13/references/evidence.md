...
- Exact model source/model card: https://huggingface.co/deepseek-ai/DeepSeek-R1-Distill-Qwen-14B
- DeepSeek R1 Distill Qwen 14B source: https://huggingface.co/deepseek-ai/DeepSeek-R1-Distill-Qwen-14B (model-card)
