...
- Exact model source/model card: https://huggingface.co/ibm-granite/granite-4.1-8b
- Granite 4.1 8B source: https://huggingface.co/ibm-granite/granite-4.1-8b (model-card)
