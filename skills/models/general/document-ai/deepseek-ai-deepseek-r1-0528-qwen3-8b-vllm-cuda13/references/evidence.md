...
- Exact model source/model card: https://huggingface.co/deepseek-ai/DeepSeek-R1-0528-Qwen3-8B
- DeepSeek R1 0528 Qwen3 8B source: https://huggingface.co/deepseek-ai/DeepSeek-R1-0528-Qwen3-8B (model-card)
