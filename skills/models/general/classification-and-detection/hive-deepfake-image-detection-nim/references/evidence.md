...
- Exact model source/model card: https://build.nvidia.com/hive/deepfake-image-detection
- Hive Deepfake Image Detection source: https://build.nvidia.com/hive/deepfake-image-detection (model-card)
