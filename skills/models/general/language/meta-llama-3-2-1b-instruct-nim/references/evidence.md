...
- Exact model source/model card: https://build.nvidia.com/meta/llama-3.2-1b-instruct
- Meta Llama 3.2 1B Instruct source: https://build.nvidia.com/meta/llama-3.2-1b-instruct (model-card)
