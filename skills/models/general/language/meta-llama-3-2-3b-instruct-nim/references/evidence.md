...
- Exact model source/model card: https://build.nvidia.com/meta/llama-3.2-3b-instruct
- Meta Llama 3.2 3B Instruct source: https://build.nvidia.com/meta/llama-3.2-3b-instruct (model-card)
