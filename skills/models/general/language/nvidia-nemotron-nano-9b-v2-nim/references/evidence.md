...
- Exact model source/model card: https://build.nvidia.com/nvidia/nvidia-nemotron-nano-9b-v2
- NVIDIA Nemotron Nano 9B v2 source: https://build.nvidia.com/nvidia/nvidia-nemotron-nano-9b-v2 (model-card)
