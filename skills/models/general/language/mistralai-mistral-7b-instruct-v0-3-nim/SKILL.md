---
name: use-forge-mistralai-mistral-7b-instruct-v0-3-nim
description: Use exact Forge model mistralai-mistral-7b-instruct-v0-3-nim for text to text. Load when selecting, calling, comparing, interpreting, or deploying this specific version.
---

# Use Mistral 7B Instruct v0.3

- Model slug: `mistralai-mistral-7b-instruct-v0-3-nim`
- Family: `mistralai-mistral-7b-instruct-v0-3`
- Version: `v1` (`v1`)
...
- Use this exact `mistralai-mistral-7b-instruct-v0-3-nim` version when the task supplies text and needs text.
- Mistral 7B Instruct v0.3 packaged as an NVIDIA NIM and mirrored into Forge regional registries.
...
1. Load this skill and pin model slug `mistralai-mistral-7b-instruct-v0-3-nim` with version key `v1`.
...
- Model: `/v1/models/mistralai-mistral-7b-instruct-v0-3-nim`
