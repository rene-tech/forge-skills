...
- Exact model source/model card: https://build.nvidia.com/mistralai/mistral-7b-instruct-v0.3
- Mistral 7B Instruct v0.3 source: https://build.nvidia.com/mistralai/mistral-7b-instruct-v0.3 (model-card)
