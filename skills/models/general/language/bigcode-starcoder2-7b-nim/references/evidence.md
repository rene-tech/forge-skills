...
- Exact model source/model card: https://build.nvidia.com/bigcode/starcoder2-7b
- BigCode StarCoder2 7B source: https://build.nvidia.com/bigcode/starcoder2-7b (model-card)
