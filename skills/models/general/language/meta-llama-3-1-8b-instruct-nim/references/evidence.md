...
- Exact model source/model card: https://build.nvidia.com/meta/llama-3.1-8b-instruct
- Meta Llama 3.1 8B Instruct source: https://build.nvidia.com/meta/llama-3.1-8b-instruct (model-card)
