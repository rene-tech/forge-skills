...
- Exact model source/model card: https://huggingface.co/Qwen/Qwen3-30B-A3B-Instruct-2507
- Qwen3 30B A3B Instruct 2507 BF16 source: https://huggingface.co/Qwen/Qwen3-30B-A3B-Instruct-2507 (model-card)
