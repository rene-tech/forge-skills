...
- Exact model source/model card: https://build.nvidia.com/microsoft/phi-3-mini-4k-instruct
- Microsoft Phi-3 Mini 4K Instruct source: https://build.nvidia.com/microsoft/phi-3-mini-4k-instruct (model-card)
