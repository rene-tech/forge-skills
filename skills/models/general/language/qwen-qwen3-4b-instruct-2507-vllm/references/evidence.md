...
- Exact model source/model card: https://huggingface.co/Qwen/Qwen3-4B-Instruct-2507
- Qwen3 4B Instruct 2507 source: https://huggingface.co/Qwen/Qwen3-4B-Instruct-2507 (model-card)
