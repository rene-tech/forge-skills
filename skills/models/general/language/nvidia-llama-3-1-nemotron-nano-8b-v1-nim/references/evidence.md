...
- Exact model source/model card: https://build.nvidia.com/nvidia/llama-3.1-nemotron-nano-8b-v1
- NVIDIA Llama 3.1 Nemotron Nano 8B v1 source: https://build.nvidia.com/nvidia/llama-3.1-nemotron-nano-8b-v1 (model-card)
