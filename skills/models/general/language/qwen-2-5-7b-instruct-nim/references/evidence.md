...
- Exact model source/model card: https://build.nvidia.com/qwen/qwen-2.5-7b-instruct
- Qwen 2.5 7B Instruct source: https://build.nvidia.com/qwen/qwen-2.5-7b-instruct (model-card)
