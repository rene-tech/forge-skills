...
- Exact model source/model card: https://huggingface.co/microsoft/Phi-4-mini-reasoning
- Microsoft Phi-4 Mini Reasoning source: https://huggingface.co/microsoft/Phi-4-mini-reasoning (model-card)
