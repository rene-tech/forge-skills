...
- Exact model source/model card: https://build.nvidia.com/nvidia/llama-3.1-nemoguard-8b-content-safety
- NVIDIA Llama 3.1 NemoGuard 8B Content Safety source: https://build.nvidia.com/nvidia/llama-3.1-nemoguard-8b-content-safety (model-card)
