---
name: use-forge-black-forest-labs-flux-2-klein-4b-diffusers
description: Use exact Forge model black-forest-labs-flux-2-klein-4b-diffusers for text, image to image. Load when selecting, calling, comparing, interpreting, or deploying this specific version.
---

# Use FLUX.2 Klein 4B

- Model slug: `black-forest-labs-flux-2-klein-4b-diffusers`
- Family: `black-forest-labs-flux-2-klein-4b`
- Version: `4b-diffusers-cuda12.8-v1` (`4b-diffusers`)
...
Fast distilled FLUX.2 Klein 4B running in a Forge-owned Diffusers container.

## Use this exact model when

- Use this exact `black-forest-labs-flux-2-klein-4b-diffusers` version when the task supplies text, image and needs image.
- Fast distilled FLUX.2 Klein 4B running in a Forge-owned Diffusers container.
...
- `steps` (number; optional; bounds 1..100; default 4): Steps
...
Route: `POST /v1/inference/black-forest-labs-flux-2-klein-4b-diffusers`
...
1. Load this skill and pin model slug `black-forest-labs-flux-2-klein-4b-diffusers` with version key `4b-diffusers`.
2. Fetch the live model detail and inference-routes endpoints before every run.
3. Validate the exact required fields and parameter bounds listed below; do not silently coerce, truncate, or omit inputs.
4. Call `POST /v1/inference/black-forest-labs-flux-2-klein-4b-diffusers` using the declared request template.
...
- Model: `/v1/models/black-forest-labs-flux-2-klein-4b-diffusers`
- Routes: `/v1/models/black-forest-labs-flux-2-klein-4b-diffusers/inference-routes`
- Regional deployment: `/v1/models/black-forest-labs-flux-2-klein-4b-diffusers/regional-deployment`
- Serverless handoff: `/v1/models/black-forest-labs-flux-2-klein-4b-diffusers/deploy`
...
- Repository file: https://github.com/rene-tech/forge-skills/blob/main/skills/models/general/image-generation/black-forest-labs-flux-2-klein-4b-diffusers/SKILL.md
