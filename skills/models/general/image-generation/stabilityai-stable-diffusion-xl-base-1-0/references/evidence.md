...
- Exact model source/model card: https://huggingface.co/stabilityai/stable-diffusion-xl-base-1.0
- Stable Diffusion XL Base 1.0 source: https://huggingface.co/stabilityai/stable-diffusion-xl-base-1.0 (model-card)
