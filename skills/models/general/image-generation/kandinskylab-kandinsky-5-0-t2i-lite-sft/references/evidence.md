...
- Exact model source/model card: https://huggingface.co/docs/diffusers/api/pipelines/kandinsky5_image
- Kandinsky 5.0 T2I Lite SFT source: https://huggingface.co/docs/diffusers/api/pipelines/kandinsky5_image (model-card)
