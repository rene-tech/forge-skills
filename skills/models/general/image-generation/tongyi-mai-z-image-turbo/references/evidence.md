...
- Exact model source/model card: https://huggingface.co/docs/diffusers/v0.38.0/en/api/pipelines/z_image
- Z-Image Turbo source: https://huggingface.co/docs/diffusers/v0.38.0/en/api/pipelines/z_image (model-card)
