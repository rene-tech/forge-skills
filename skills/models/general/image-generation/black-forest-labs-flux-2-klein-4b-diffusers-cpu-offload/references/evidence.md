...
- Exact model source/model card: https://huggingface.co/black-forest-labs/FLUX.2-klein-4B
- FLUX.2 Klein 4B source: https://huggingface.co/black-forest-labs/FLUX.2-klein-4B (model-card)
