...
- Exact model source/model card: https://huggingface.co/black-forest-labs/FLUX.2-klein-base-4B
- FLUX.2 Klein 4B Base source: https://huggingface.co/black-forest-labs/FLUX.2-klein-base-4B (model-card)
