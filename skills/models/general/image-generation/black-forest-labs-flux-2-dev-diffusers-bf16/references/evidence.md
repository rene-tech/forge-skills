...
- Exact model source/model card: https://huggingface.co/black-forest-labs/FLUX.2-dev
- FLUX.2 Dev source: https://huggingface.co/black-forest-labs/FLUX.2-dev (model-card)
