...
- Exact model source/model card: https://huggingface.co/Snowflake/snowflake-arctic-embed-m-v2.0
- Snowflake Arctic Embed M v2.0 source: https://huggingface.co/Snowflake/snowflake-arctic-embed-m-v2.0 (model-card)
