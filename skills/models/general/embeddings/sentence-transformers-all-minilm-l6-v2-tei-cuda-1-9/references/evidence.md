...
- Exact model source/model card: https://huggingface.co/sentence-transformers/all-MiniLM-L6-v2
- All-MiniLM-L6-v2 source: https://huggingface.co/sentence-transformers/all-MiniLM-L6-v2 (model-card)
