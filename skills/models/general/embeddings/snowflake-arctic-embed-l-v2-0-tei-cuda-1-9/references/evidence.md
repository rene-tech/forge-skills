...
- Exact model source/model card: https://huggingface.co/Snowflake/snowflake-arctic-embed-l-v2.0
- Snowflake Arctic Embed L v2.0 source: https://huggingface.co/Snowflake/snowflake-arctic-embed-l-v2.0 (model-card)
