...
- Exact model source/model card: https://huggingface.co/Qwen/Qwen3-Embedding-4B
- Qwen3 Embedding 4B source: https://huggingface.co/Qwen/Qwen3-Embedding-4B (model-card)
