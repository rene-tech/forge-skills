---
name: use-forge-qwen-qwen3-embedding-4b-vllm-cuda13
description: Use exact Forge model qwen-qwen3-embedding-4b-vllm-cuda13 for text to embedding. Load when selecting, calling, comparing, interpreting, or deploying this specific version.
---

# Use Qwen3 Embedding 4B

- Model slug: `qwen-qwen3-embedding-4b-vllm-cuda13`
...
Qwen3 Embedding 4B served by the already mirrored official vLLM 0.21.0 CUDA 13 OpenAI-compatible image in pooling runner mode.

## Use this exact model when

- Use this exact `qwen-qwen3-embedding-4b-vllm-cuda13` version when the task supplies text and needs embedding.
- Qwen3 Embedding 4B served by the already mirrored official vLLM 0.21.0 CUDA 13 OpenAI-compatible image in pooling runner mode.
...
1. Load this skill and pin model slug `qwen-qwen3-embedding-4b-vllm-cuda13` with version key `vllm-0-21-0-cuda13-embed`.
...
- Model: `/v1/models/qwen-qwen3-embedding-4b-vllm-cuda13`
