...
- Exact model source/model card: https://huggingface.co/BAAI/bge-large-en-v1.5
- BGE Large EN v1.5 source: https://huggingface.co/BAAI/bge-large-en-v1.5 (model-card)
