...
- Exact model source/model card: https://huggingface.co/Alibaba-NLP/gte-modernbert-base
- GTE ModernBERT Base source: https://huggingface.co/Alibaba-NLP/gte-modernbert-base (model-card)
