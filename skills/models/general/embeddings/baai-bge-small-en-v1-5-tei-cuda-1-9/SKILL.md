---
name: use-forge-baai-bge-small-en-v1-5-tei-cuda-1-9
description: Use exact Forge model baai-bge-small-en-v1-5-tei-cuda-1-9 for text to embedding. Load when selecting, calling, comparing, interpreting, or deploying this specific version.
---

# Use BGE Small EN v1.5

- Model slug: `baai-bge-small-en-v1-5-tei-cuda-1-9`
...
BAAI bge-small-en-v1.5 is a public MIT-licensed English embedding model for semantic search, short RAG retrieval, clustering, and low-cost passage ranking.

## Use this exact model when

- Use this exact `baai-bge-small-en-v1-5-tei-cuda-1-9` version when the task supplies text and needs embedding.
- BAAI bge-small-en-v1.5 is a public MIT-licensed English embedding model for semantic search, short RAG retrieval, clustering, and low-cost passage ranking.
...
1. Load this skill and pin model slug `baai-bge-small-en-v1-5-tei-cuda-1-9` with version key `tei-cuda-1-9-3`.
...
- Model: `/v1/models/baai-bge-small-en-v1-5-tei-cuda-1-9`
