...
- Exact model source/model card: https://huggingface.co/BAAI/bge-small-en-v1.5
- BGE Small EN v1.5 source: https://huggingface.co/BAAI/bge-small-en-v1.5 (model-card)
