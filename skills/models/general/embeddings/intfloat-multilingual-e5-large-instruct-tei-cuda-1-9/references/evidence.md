...
- Exact model source/model card: https://huggingface.co/intfloat/multilingual-e5-large-instruct
- Multilingual E5 Large Instruct source: https://huggingface.co/intfloat/multilingual-e5-large-instruct (model-card)
