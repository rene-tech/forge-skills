...
- Exact model source/model card: https://huggingface.co/nomic-ai/nomic-embed-text-v2-moe
- Nomic Embed Text v2 MoE source: https://huggingface.co/nomic-ai/nomic-embed-text-v2-moe (model-card)
