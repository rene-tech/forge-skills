...
- Exact model source/model card: https://huggingface.co/Qwen/Qwen3-Embedding-0.6B
- Qwen3 Embedding 0.6B source: https://huggingface.co/Qwen/Qwen3-Embedding-0.6B (model-card)
