...
- Exact model source/model card: https://build.nvidia.com/nvidia/llama-3_2-nv-embedqa-1b-v2
- NVIDIA Llama 3.2 NV-EmbedQA 1B v2 source: https://build.nvidia.com/nvidia/llama-3_2-nv-embedqa-1b-v2 (model-card)
