...
- Exact model source/model card: https://build.nvidia.com/nvidia/llama-nemotron-embed-1b-v2
- NVIDIA Llama Nemotron Embed 1B v2 source: https://build.nvidia.com/nvidia/llama-nemotron-embed-1b-v2 (model-card)
