...
- Exact model source/model card: https://huggingface.co/Qwen/Qwen3-Embedding-8B
- Qwen3 Embedding 8B source: https://huggingface.co/Qwen/Qwen3-Embedding-8B (model-card)
