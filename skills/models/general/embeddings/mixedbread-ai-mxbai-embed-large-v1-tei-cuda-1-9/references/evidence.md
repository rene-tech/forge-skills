...
- Exact model source/model card: https://huggingface.co/mixedbread-ai/mxbai-embed-large-v1
- Mixedbread Embed Large v1 source: https://huggingface.co/mixedbread-ai/mxbai-embed-large-v1 (model-card)
