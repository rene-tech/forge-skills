...
- Exact model source/model card: https://huggingface.co/Qwen/Qwen3-Reranker-4B
- Qwen3 Reranker 4B source: https://huggingface.co/Qwen/Qwen3-Reranker-4B (model-card)
