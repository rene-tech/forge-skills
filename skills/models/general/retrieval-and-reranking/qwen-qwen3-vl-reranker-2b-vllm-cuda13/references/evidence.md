...
- Exact model source/model card: https://huggingface.co/Qwen/Qwen3-VL-Reranker-2B
- Qwen3-VL Reranker 2B source: https://huggingface.co/Qwen/Qwen3-VL-Reranker-2B (model-card)
