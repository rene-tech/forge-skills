...
- Exact model source/model card: https://huggingface.co/BAAI/bge-reranker-v2-m3
- BGE Reranker v2 M3 source: https://huggingface.co/BAAI/bge-reranker-v2-m3 (model-card)
