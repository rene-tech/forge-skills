...
- Exact model source/model card: https://huggingface.co/Alibaba-NLP/gte-reranker-modernbert-base
- GTE Reranker ModernBERT Base source: https://huggingface.co/Alibaba-NLP/gte-reranker-modernbert-base (model-card)
